...
#define API_SOURCE_NAME "vrtlmodapi.cpp"
  ...
  public:
    std::string get_vrtltopheader_filename(void) { return (mTopTypeName + ".h"); }
    std::string get_vrtltopsymsheader_filename(void) { return (mTopTypeName + "__Syms.h"); }
    std::string get_targetdictionary_filename(void) { return (API_TD_HEADER_NAME); }
    std::string get_targetdictionary_relpath(void)
    {
        return (std::string(API_TD_DIRPREFIX) + std::string("/") + get_targetdictionary_filename());
    }
    std::string get_apiheader_filename(void) { return (mTopTypeName + std::string("_") + API_HEADER_NAME); }
    std::string get_apisource_filename(void) { return (mTopTypeName + std::string("_") + API_SOURCE_NAME); }

    ///////////////////////////////////////////////////////////////////////
    /// \brief Returns output directory
    std::string &get_outputDir(void) { return (outdir_); }
    ///////////////////////////////////////////////////////////////////////
    /// \brief Returns true if the API generator was configured for SystemC VRTL
    bool is_systemc(void) { return (systemc_); }
    ///////////////////////////////////////////////////////////////////////
