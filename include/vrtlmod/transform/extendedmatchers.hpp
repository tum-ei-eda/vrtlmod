...
#ifndef __VRTLMOD_TRANSFORM_EXTENDEDMATCHERS_HPP__
#define __VRTLMOD_TRANSFORM_EXTENDEDMATCHERS_HPP__
...
class Ext
{
  ...
  public:
    ...
    unsigned size(void) const { return (End.getRawEncoding() - Begin.getRawEncoding()); }
    ///////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////
    /// \brief Contains unique identification of main expression
    unsigned get_ID(void) { return (mID); }
    ///////////////////////////////////////////////////////////////////////
    /// \brief Returns self representation string. Should be specified further by inheriting classes
    virtual std::string _self(void) const { return ("Empty Extended Matcher"); }
    ///////////////////////////////////////////////////////////////////////
    ...
    Ext(unsigned ID, transform::Handler &handler, clang::SourceLocation Begin, clang::SourceLocation End)
...
class ExtAsgnmnt : public Ext
{
  ...
  public:
    ...
    ExtAsgnmnt(const clang::BinaryOperator *op, transform::Handler &handler, type_t type);
    ///////////////////////////////////////////////////////////////////////
    /// \brief Destructor
    virtual ~ExtAsgnmnt() {}
};
...
class ExtTrivAsgnmnt : public ExtAsgnmnt
{
  public:
    ...
    {
        util::logging::log(util::logging::ERROR, "Trivial Assignment has no base");
        return (nullptr);
    };
    ///////////////////////////////////////////////////////////////////////
    ...
    {
        util::logging::log(util::logging::ERROR, "Trivial Assignment has no index");
        return (nullptr);
    }
    ///////////////////////////////////////////////////////////////////////
    /// \brief Constructor
    /// \param op Pointer to main defining expression
    /// \param handler
    ExtTrivAsgnmnt(const clang::BinaryOperator *op, transform::Handler &handler)
...
class ExtArrayAsgnmnt : public ExtAsgnmnt
{
  public:
    ...
    /// \param op Pointer to main defining expression
    /// \param handler
    ExtArrayAsgnmnt(const clang::ArraySubscriptExpr *ase, const clang::BinaryOperator *op, transform::Handler &handler)
...
class ExtCompoundStmt : public Ext
{
  public:
    ...
    /// \details A dominant assignment is the control-flow specific last assignment in a compound accessing the same
    /// data element \return Vector containing all dominant assignments
    ...
    /// \param handler
    ExtCompoundStmt(const clang::Stmt *c, transform::Handler &handler)
...
class ExtDeclFunc : public Ext
{
  public:
    ...
    std::vector<vapi::Target *> mInjectedTargets;
    ///////////////////////////////////////////////////////////////////////
    /// \brief Vector containing all compounds in this function
    /// \details As specific assignments are sorted by their respective calling compound this is crucial for identifying
    /// the actual location
    ...
    void addInjTarget(vapi::Target &t);
    ///////////////////////////////////////////////////////////////////////
    /// \brief Add a compound to this function
    void addCompound(ExtCompoundStmt *x) { mCompounds.push_back(x); }
    ///////////////////////////////////////////////////////////////////////
    /// \brief Get the finest-grained compound for a given assignments
    /// \param a Pointer to assignment
    /// \return Compound where assignment is located or nullptr if assignment is not in range of function (not in range
    /// of any of its compounds)
    ...
    /// \param handler
    ExtDeclFunc(const clang::Decl *f, transform::Handler &handler)
...
#endif /* __VRTLMOD_TRANSFORM_EXTENDEDMATCHERS_HPP__ */
